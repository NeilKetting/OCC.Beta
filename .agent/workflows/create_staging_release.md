...
```powershell
dotnet publish OCC.Client.Desktop/OCC.Client.Desktop.csproj -c Release -o publish_staging /p:DefineConstants="STAGING"; vpk pack -u "OCC-Staging" -p publish_staging -e "OCC.Client.Desktop.exe" --packTitle "OCC Staging" --packAuthors "Origize63" -v 1.4.5-staging -o staging-releases
```
