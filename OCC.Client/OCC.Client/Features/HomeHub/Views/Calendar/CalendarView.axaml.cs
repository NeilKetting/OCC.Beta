...
namespace OCC.Client.Features.HomeHub.Views.Calendar
{
    public partial class CalendarView : UserControl
    {
        ...
        {
            if (sender is Border border && border.DataContext is OCC.Client.Features.HomeHub.ViewModels.Calendar.CalendarTaskViewModel task)
            {
