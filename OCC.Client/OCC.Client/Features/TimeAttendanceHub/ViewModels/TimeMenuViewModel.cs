...
namespace OCC.Client.Features.TimeAttendanceHub.ViewModels
{
    public partial class TimeMenuViewModel : ViewModelBase, IRecipient<SwitchTabMessage>
    {
        ...
        [NotifyPropertyChangedFor(nameof(IsLoansActive))] // Added
        ...
        public bool IsLoansActive => ActiveTab is "Loans"; // Added
        ...
        public bool CanAccessLoans => _permissionService.CanAccess(NavigationRoutes.Feature_Loans); // Added
