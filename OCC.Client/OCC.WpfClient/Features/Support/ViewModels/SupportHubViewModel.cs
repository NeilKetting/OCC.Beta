...
namespace OCC.WpfClient.Features.Support.ViewModels
{
    public partial class SupportHubViewModel : ViewModelBase
    {
        ...
        public SupportHubViewModel(IBugReportService bugService, IAuthService authService)
        {
